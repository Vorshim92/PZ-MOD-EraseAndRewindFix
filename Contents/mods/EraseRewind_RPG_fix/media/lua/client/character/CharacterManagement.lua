...
function CharacterManagement.writeBook(character, modData_table)
    ...
    --scrittura di tutti i dati finiti 
    --adesso spediamo la tabella al server
    CharacterManagement.sendServerData(character, modData_table)

    --------------------------
end

function CharacterManagement.sendServerData(character, modData_table)
    local name
    if modData_table == pageBook.Character.TimedBook then
